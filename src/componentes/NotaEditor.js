                ...
                <View style={estilos.centralizaModal}>
                    <ScrollView showsVerticalScrollIndicator={false}>
                        <View style={estilos.modal}>
                            ...
                            <Text style={estilos.modalSubTitulo}>Título da noda</Text>
                            <TextInput
                            ...
                            <View style={estilos.modalBotoes}>
                                ...
                                <TouchableOpacity style={estilos.modalBotaoSalvar} onPress={() => { notaParaAtualizar ? modificaNota() : salvaNota() }}>
                                    <Text style={estilos.modalBotaoTexto}>Salvar</Text>
                                </TouchableOpacity>
                                {notaParaAtualizar ?
                                    <TouchableOpacity style={estilos.modalBotaoDeletar} onPress={() => { apagaNota() }}>
                                        <Text style={estilos.modalBotaoTexto}>Apagar</Text>
                                    </TouchableOpacity> : <></>
                                }
